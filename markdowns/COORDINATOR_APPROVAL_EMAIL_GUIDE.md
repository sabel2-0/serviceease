...
When an admin approves a coordinator registration, the system will automatically send a professional email notification to the coordinator's email address, informing them that their account is ready to use.
...
3. **Configure Template Settings**
   ...
   **Subject Line:**
   ```
   Your ServiceEase Coordinator Account Has Been Approved! 🎉
   ```
   ...
   <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
       <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
           ...
           <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
               ...
               <p>Great news! Your ServiceEase coordinator account has been approved by our admin team.</p>
...
5. **Configure Template Variables**
   ...
   - `{{coordinator_email}}` - Coordinator's email address
...
| `{{to_email}}` | Recipient (same as coordinator_email) | "john@institution.edu" |
...
2. **Welcome Email with Instructions**
   ...
   - List first steps for coordinators
