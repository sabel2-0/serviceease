...
**Problem:** The service approval modal in The institution_admin page was too large and didn't fit well on the screen.
...
1. One to The institution_user saying "Service Completed - Awaiting Approval"
2. One to The institution_admin saying "Service Request Pending Your Approval"

This caused duplicate notifications in the notifications page.

**Solution:**
- Removed the notification to The institution_user when service is submitted for approval
- Now only The institution_admin receives a notification when service is pending approval
- The institution_user will receive a notification AFTER The institution_admin approves the service (handled by the approval routes)
...
1. Login as An institution_admin
...
3. Login as An institution_admin
...
2. Login as institution_admin, check notifications (should see 1 notification)
3. Approve the service request
4. Login as institution_user, check notifications (should see approval notification)
5. Verify no duplicate notifications at any stage

## Additional Notes

- The fix ensures a cleaner, more professional UI for The institution_admin approval process
