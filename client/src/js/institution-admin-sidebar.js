...
async function loadSidebar() {
    try {
        const response = await fetch('../../components/institution_admin-sidebar.html');
        const html = await response.text();
        const tempContainer = document.createElement('div');
        tempContainer.innerHTML = html;
        
        const sidebarContent = tempContainer.querySelector('.institution_admin-sidebar-component');
...
async function updateNotificationBadges() {
    try {
        const response = await fetch('/api/institutionAdmin/notification-counts', {
            headers: {
