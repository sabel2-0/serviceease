// Requester Notifications Module
(function() {
  console.log('🔔 [REQUESTER-NOTIFICATIONS] Module loading...');
  ...
  const RequesterNotifications = {
    ...
    init() {
      if (this.initialized) {
        console.log('🔔 [REQUESTER-NOTIFICATIONS] Already initialized, refreshing...');
        this.refresh();
        return;
      }
      
      console.log('🔔 [REQUESTER-NOTIFICATIONS] Initializing...');
    ...
    refresh() {
      console.log('🔔 [REQUESTER-NOTIFICATIONS] Refreshing notifications...');
      this.fetchNotifications();
    },
    ...
    async fetchNotifications() {
      ...
      try {
        ...
        console.log('🔔 [REQUESTER-NOTIFICATIONS] Fetching from API...');
        ...
        console.log('🔔 [REQUESTER-NOTIFICATIONS] Received:', notifications.length, 'notifications');
        
        this.renderNotifications(notifications);
      } catch (error) {
        console.error('🔔 [REQUESTER-NOTIFICATIONS] Error:', error);
        this.showError();
      }
    },
  ...
  // Expose globally
  window.RequesterNotifications = RequesterNotifications;
  console.log('🔔 [REQUESTER-NOTIFICATIONS] Module loaded');
})();
