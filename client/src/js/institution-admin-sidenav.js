/**
 * institutionAdmin Sidenav Loader
 * 
 * This file handles the loading of the institutionAdmin sidenav component.
 */
...
/**
 * Load the institutionAdmin sidenav component
 */
async function loadSidenav() {
    try {
        ...
        const paths = [
            '../../components/institution-admin-sidenav.html', // Components directory (CORRECT PATH)
            '../components/institution-admin-sidenav.html', // Relative components directory
            '/components/institution-admin-sidenav.html', // Root components
            '/src/components/institution-admin-sidenav.html', // Root src/components
            '/client/src/components/institution-admin-sidenav.html', // Absolute path
            '../../src/components/institution-admin-sidenav.html', // From js directory up to src/components
            'institution-admin-sidenav.html', // Same directory - LOWER PRIORITY
            '../institution-admin/institution-admin-sidenav.html', // From a pages subdirectory - LOWER PRIORITY
            '../../pages/institution-admin/institution-admin-sidenav.html', // From src/js to pages/institution-admin - LOWER PRIORITY
            '/client/src/pages/institution-admin/institution-admin-sidenav.html' // Absolute path to pages - LOWER PRIORITY
        ];
        ...
        const sidenavContent = tempContainer.firstChild || tempContainer.querySelector('.institution_admin-sidenav') || tempContainer;
        ...
        try {
            ...
            const directLoad = await fetch('/client/src/components/institution_admin-sidenav.html');
            if (directLoad.ok) {
    ...
    sidebarContainer.innerHTML = `
        <div class="h-full bg-gray-900 w-64 min-h-screen shadow-lg p-4">
            <div class="px-4 py-6 border-b border-gray-800">
                ...
                <p class="text-xs text-gray-400">institutionAdmin Portal</p>
            </div>
    ...
    if (logoutBtn) {
        logoutBtn.addEventListener('click', () => {
            ...
            if (currentPath.includes('/pages/admin/') || 
                ...
                currentPath.includes('/pages/institutionAdmin/') ||
